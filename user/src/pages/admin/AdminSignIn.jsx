...
const AdminSignIn = () => {
  ...
  const handleSubmit = async (e)=>{
      ...
      try {
        ...
        if (data.isAdmin !== 1) {
          dispatch(signInFailure({ message: 'Not authorized to access admin panel' }));
          return;
        }
    ...
    <div className="p-12 max-w-lg mx-auto my-10 rounded-lg shadow-2xl bg-cover bg-center">
      ...
      <form onSubmit={handleSubmit} className="flex flex-col gap-4">
        ...
        <input
          ...
          onChange={handleChange}
        />
        <button disabled={loading} className="bg-slate-700 text-white rounded-lg p-3 hover:opacity-60 disabled:opacity-95 uppercase">
